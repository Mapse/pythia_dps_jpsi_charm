// -*- C++ -*-
//
// Package:    GenTutorial/GenLevelJpsiDzero100TeV
// Class:      GenLevelJpsiDzero100TeV
//
/**\class GenLevelJpsiDzero100TeV GenLevelJpsiDzero100TeV.cc GenTutorial/GenLevelJpsiDzero100TeV/plugins/GenLevelJpsiDzero100TeV.cc
...
class GenLevelJpsiDzero100TeV : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
	public:
		explicit GenLevelJpsiDzero100TeV(const edm::ParameterSet&);
		~GenLevelJpsiDzero100TeV();
...
////////////////////////////////////////////////////////////////////////////
GenLevelJpsiDzero100TeV::GenLevelJpsiDzero100TeV(const edm::ParameterSet& iConfig)
...
GenLevelJpsiDzero100TeV::~GenLevelJpsiDzero100TeV()
{
...
/////////////////////
void GenLevelJpsiDzero100TeV::beginJob()
{
    // Open a ROOT file to store the output
    outFile_ = new TFile("control_plots_jpsidzero_100TeV.root", "RECREATE");
...
void GenLevelJpsiDzero100TeV::initialize()
{
...
void GenLevelJpsiDzero100TeV::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	using namespace edm;
	using namespace std;
	...
	if (genParticles.isValid()) {
		...
		for (size_t i=0; i < jpsiParticles.size(); ++i){
			...
			for (size_t j=0; j < dzeroParticles.size(); ++j){
				...
				Double_t dphi = abs(jpsiParticles[i].Phi() - dzeroParticles[j].Phi());
...
///////
//++++++++++++++++++
void GenLevelJpsiDzero100TeV::endJob(){
...
DEFINE_FWK_MODULE(GenLevelJpsiDzero100TeV);
