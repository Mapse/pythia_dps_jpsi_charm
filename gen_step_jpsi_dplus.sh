...
if [ $# -ne 2 ]; then
    ...
    echo "Example: source gen_step_jpsi_dplus.sh 13TeV 200000"
fi
...
## Path to gs frameng
path_gs=Configuration/GenProduction/python/Jpsi_Dplus_DPS_${energy}_cfi.py

# GS cfg fragment 
py_gs=Jpsi_Dplus_DPS_${energy}_GS_cfg.py
# For MC Gen parameters 
REPORT_NAME=Jpsi_Dplus_DPS_${energy}_report.xml

# GS root
root_gs=Jpsi_Dplus_DPS_${energy}.root
