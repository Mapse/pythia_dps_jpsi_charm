// -*- C++ -*-
//
// Package:    GenTutorial/GenLevelJpsiDzero30TeV
// Class:      GenLevelJpsiDzero30TeV
//
/**\class GenLevelJpsiDzero30TeV GenLevelJpsiDzero30TeV.cc GenTutorial/GenLevelJpsiDzero30TeV/plugins/GenLevelJpsiDzero30TeV.cc
...
class GenLevelJpsiDzero30TeV : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
	public:
		explicit GenLevelJpsiDzero30TeV(const edm::ParameterSet&);
		~GenLevelJpsiDzero30TeV();
...
////////////////////////////////////////////////////////////////////////////
GenLevelJpsiDzero30TeV::GenLevelJpsiDzero30TeV(const edm::ParameterSet& iConfig)
...
GenLevelJpsiDzero30TeV::~GenLevelJpsiDzero30TeV()
{
...
/////////////////////
void GenLevelJpsiDzero30TeV::beginJob()
{
    // Open a ROOT file to store the output
    outFile_ = new TFile("control_plots_jpsidzero_30TeV.root", "RECREATE");
...
void GenLevelJpsiDzero30TeV::initialize()
{
...
void GenLevelJpsiDzero30TeV::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	using namespace edm;
	using namespace std;
...
///////
//++++++++++++++++++
void GenLevelJpsiDzero30TeV::endJob(){
...
DEFINE_FWK_MODULE(GenLevelJpsiDzero30TeV);
