...
generator = cms.EDFilter("Pythia8GeneratorFilter",
                         ...
                         list_forced_decays = cms.vstring('MyD_s+', 'My-D_s-'), 
...
dsplusfilter = cms.EDFilter("PythiaFilter", 
...
ProductionFilterSequence = cms.Sequence(generator*jpsifilter*mumufilter*dsplusfilter)