// -*- C++ -*-
//
// Package:    GenTutorial/GenLevelJpsiDzero60TeV
// Class:      GenLevelJpsiDzero60TeV
//
/**\class GenLevelJpsiDzero60TeV GenLevelJpsiDzero60TeV.cc GenTutorial/GenLevelJpsiDzero60TeV/plugins/GenLevelJpsiDzero60TeV.cc
...
class GenLevelJpsiDzero60TeV : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
	public:
		explicit GenLevelJpsiDzero60TeV(const edm::ParameterSet&);
		~GenLevelJpsiDzero60TeV();
...
////////////////////////////////////////////////////////////////////////////
GenLevelJpsiDzero60TeV::GenLevelJpsiDzero60TeV(const edm::ParameterSet& iConfig)
...
GenLevelJpsiDzero60TeV::~GenLevelJpsiDzero60TeV()
{
...
/////////////////////
void GenLevelJpsiDzero60TeV::beginJob()
{
    // Open a ROOT file to store the output
    outFile_ = new TFile("control_plots_jpsidzero_60TeV.root", "RECREATE");
...
void GenLevelJpsiDzero60TeV::initialize()
{
...
void GenLevelJpsiDzero60TeV::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	using namespace edm;
	using namespace std;
...
///////
//++++++++++++++++++
void GenLevelJpsiDzero60TeV::endJob(){
...
DEFINE_FWK_MODULE(GenLevelJpsiDzero60TeV);
