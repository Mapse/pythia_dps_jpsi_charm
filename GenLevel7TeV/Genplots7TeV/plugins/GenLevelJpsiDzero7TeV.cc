// -*- C++ -*-
//
// Package:    GenTutorial/GenLevelJpsiDzero7TeV
// Class:      GenLevelJpsiDzero7TeV
//
/**\class GenLevelJpsiDzero7TeV GenLevelJpsiDzero7TeV.cc GenTutorial/GenLevelJpsiDzero7TeV/plugins/GenLevelJpsiDzero7TeV.cc
...
class GenLevelJpsiDzero7TeV : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
	public:
		explicit GenLevelJpsiDzero7TeV(const edm::ParameterSet&);
...
////////////////////////////////////////////////////////////////////////////
GenLevelJpsiDzero7TeV::GenLevelJpsiDzero7TeV(const edm::ParameterSet& iConfig)
...
GenLevelJpsiDzero7TeV::~GenLevelJpsiDzero7TeV()
{
...
/////////////////////
void GenLevelJpsiDzero7TeV::beginJob()
{
    // Open a ROOT file to store the output
    outFile_ = new TFile("control_plots_jpsidzero_7TeV.root", "RECREATE");
...
void GenLevelJpsiDzero7TeV::initialize()
{
...
void GenLevelJpsiDzero7TeV::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	using namespace edm;
	using namespace std;
...
///////
//++++++++++++++++++
void GenLevelJpsiDzero7TeV::endJob(){
...
DEFINE_FWK_MODULE(GenLevelJpsiDzero7TeV);
